...
export default function AdminProductsPage() {
  return (
    <div className="max-w-xl">
      <h1 className="font-display text-2xl font-semibold text-vula-dark mb-3">Products moved</h1>
      <p className="font-sans text-sm text-vula-dark/70 mb-6 leading-relaxed">
        Product editing now happens in the Vula dashboard, not here — one place to manage every
        storefront's catalogue (pricing, stock, weight-based pricing, SEO, status) instead of two
        admins that could silently drift apart.
      </p>
      <a
